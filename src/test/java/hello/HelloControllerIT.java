...
public class HelloControllerIT {
    ...
    @Test
    public void getGreetingsForAnton() throws Exception {
        ResponseEntity<String> response = template.getForEntity(base.toString()+ "greeting?name=Anton", String.class);
        assertThat(response.getBody(), is("Hello, Anton!"));
    }
}
